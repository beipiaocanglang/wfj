            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="tab-content">
                        <%--活动计划--%>
                        <form action="${ctx}/marketing/saveEditActivityPlan" method="post" class="form-horizontal tab-pane fade in active" id="home" enctype="multipart/form-data">
                            <%--活动计划保存后返回的主键ID--%>
                                        ...
                                        <div class="activity-list col-xs-12">
                                            ...
                                            <div class="col-xs-12 col-sm-10">
                                                <input class="text-center" readonly="readonly" type="text" value="<fmt:formatDate value="${createEditActiveVo.startTime}" pattern="yyyy-MM-dd" type="both"/>"
                                                       placeholder="开始时间" id="date_begin" name="s_startTime">
                                                <span>至</span>
                        ...
                        <%--种子人群--%>
                        <form action="${ctx}/marketing/seed/saveEditSeedData" method="post" class="form-horizontal tab-pane fade in" id="profile" enctype="multipart/form-data">
                            <%--活动计划保存后返回的主键ID--%>
                        ...
                        <%--标签扩散--%>
                        <form action="${ctx}/marketing/label/editLabelSpread" method="post" class="form-horizontal tab-pane fade in" id="messages">
                        ...
                        <%--选择渠道--%>
                        <form action="${ctx}/channel/saveEditChannelData" method="post" class="form-horizontal tab-pane fade in" id="settings">
                                        ...
                                        <div class="channel-information">
                                            <div class="delivery">
                                                <div class="col-md-4 message">
                                                    ...
                                                    <div class="number" id="sms_peopleNo"> </div>
                                                ...
                                                <div class="col-md-4 message message-right">
                                                    ...
                                                    <div class="number" id="fri_peopleNo">${channelVo.fri_deliveryNum}</div>
                                ...
                                <div class="select-channelpreadlist">
                                    ...
                                    <div class="analysis">
                                        <div class="col-md-5 analysistab">
                                            ...
                                            <div id="container" style="height: 300px;margin: 0 auto"></div>                                        </div>
...
<script src="${ctx }/assets/js/editactivity.js"></script>
