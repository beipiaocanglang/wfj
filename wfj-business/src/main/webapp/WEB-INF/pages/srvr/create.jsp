        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    ...
                    <form id="ec" action="${ctx }/srvr/save" method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="ip" id="ip" value="" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">软件资源：</label>
                            <div class="col-sm-10">
                                <input type="text" name="sftwe" id="sftwe" value="" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="stor" id="stor" value="" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="mem" id="mem" value="" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">网卡：</label>
                            <div class="col-sm-10">
                                <input type="text" name="ntwkCrd" id="ntwkCrd" value="" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">所属机架：</label>
                            <div class="col-sm-10">
                                <input type="text" name="fram" id="fram" value="" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="envir" id="envir" value="" class="form-control">
                            </div>
                        </div>
