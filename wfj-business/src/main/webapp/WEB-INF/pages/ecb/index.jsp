    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#export").on("click", function (evt) {
                ...
                window.open('${ctx}/ecb/exportExcel'+RequestObjectSerializer(innerData));
            });
        });
    </script>
</head>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <form id="ec" action="${ctx }/ecb" method="post" class="form-horizontal">
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <c:forEach items="${page.result}" var="item" varStatus="st">
                                <tr class="gradeC">
                                    ...
                                    <td>${item.currentConsumeAmount}</td>
                                    <td>${item.currentReturnAmount}</td>
