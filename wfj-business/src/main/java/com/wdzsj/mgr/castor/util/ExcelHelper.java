...
public class ExcelHelper<T> {
    ...
    public boolean exportExcel(List<T> lists[], String sheetNames[], OutputStream output) {
        ...
        for (int ii = 0; ii < lists.length; ii++) {
            ...
            //style.setFillBackgroundColor(XSSFColor.GREY_40_PERCENT.index);
     ...
     * @return 设置好的sheet.
     */
    public static XSSFSheet setXSSFPrompt(XSSFSheet sheet, String promptTitle, String promptContent, int firstRow,
...
//        // 数据有效性对象
//        XSSFDataValidation data_validation_view = new XSSFDataValidation(
//                regions, constraint);
...
//        sheet.addValidationData(data_validation_view);
     ...
     * @return 设置好的sheet.
     */
    public static Sheet setXSSFValidation(XSSFSheet sheet, String[] textlist, int firstRow, int endRow, int firstCol, int endCol) {
        ...
        final CellRangeAddressList addressList = new CellRangeAddressList(firstRow, endRow, firstCol, endCol);
        final DataValidationConstraint dvConstraint = h.createExplicitListConstraint(textlist);
